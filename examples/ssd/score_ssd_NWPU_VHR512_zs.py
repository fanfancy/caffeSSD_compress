...
model_name = "VGG_NWPU_VHR512_{}".format(job_name)

# Directory which stores the model .prototxt file.
save_dir = "models/VGGNet/NWPU_VHR512/{}_score".format(job_name)
# Directory which stores the snapshot of trained models.
snapshot_dir = "models/VGGNet/NWPU_VHR512/{}".format(job_name)
# Directory which stores the job script and log file.
job_dir = "jobs/VGGNet/NWPU_VHR512/{}_score".format(job_name)
# Directory which stores the detection results.
output_result_dir = "{}/data/VOCdevkit/results/NWPU_VHR512/{}_score/Main".format(os.environ['HOME'], job_name)
...
# The resume model.
pretrain_model = "{}_iter_{}.caffemodel".format(snapshot_prefix, 38996)
# Stores LabelMapItem.
